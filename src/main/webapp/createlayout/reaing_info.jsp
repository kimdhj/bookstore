...
<head>
    <link href="./readinginfo_css.css" rel="stylesheet">
</head>
            ...
            <div id="top_info" class="row">
                ...
                <div class="col" id="text">
                    <div class="row" id="title">
                        <div id="item_title" class="col-6">구독상품 이름</div>
                        <div id="btn_box" class="col-6">
                            <div class="col" id="cancel_btn"><button type="button" class="btn btn-danger">구독 취소</button>
                            </div>
                            <div class="col" id="modify_btn"><button type="button" class="btn btn-info">구독 정보
                                    변경</button></div>
                        </div>
                    </div>
