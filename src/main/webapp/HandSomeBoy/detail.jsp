                                ...
                                <div class="col-8" id="review_starSolo">
                                    <div class="col-10" id="star_solo">
                                        <form name="myform1" id="myform" method="post" action="./save">
                                            <fieldset>
                                                <input disabled type="radio" name="rating1" value="5" id="rate1"><label
                                                    for="rate1">⭐</label>
                                                <input checked type="radio" name="rating1" value="4" id="rate2"><label
                                                    for="rate2">⭐</label>
                                                <input disabled type="radio" name="rating1" value="3" id="rate3"><label
                                                    for="rate3">⭐</label>
                                                <input disabled type="radio" name="rating1" value="2" id="rate4"><label
                                                    for="rate4">⭐</label>
                                                <input disabled type="radio" name="rating1" value="1" id="rate5"><label
                                                    for="rate5">⭐</label>
                                            </fieldset>
                                        </form>
                                    </div>
...
<jsp:include page="./scriptStart.jsp"></jsp:include>
<!--script 추가  -->
