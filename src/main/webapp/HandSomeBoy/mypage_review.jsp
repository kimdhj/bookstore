...
<!-- 여기 css 추가  -->
    <link href="./mypage_review.css" rel="stylesheet">
                                        ...
                                        <div id="starBox" class="col-1">
                                            <form class="row" name="myform" id="myform" method="post" action="./save">
                                                <fieldset>
                                                    ...
                                                    <input class="col" checked type="radio" name="rating" value="4"
                                                        id="rate2"><label for="rate2">⭐</label>
                                                    <input class="col" disabled type="radio" name="rating" value="3"
                                                        id="rate3"><label for="rate3">⭐</label>
                                                    <input class="col" disabled type="radio" name="rating" value="2"
                                                        id="rate4"><label for="rate4">⭐</label>
                                                    <input class="col" disabled type="radio" name="rating" value="1"
